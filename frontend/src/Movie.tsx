        ...
        <div className={styles.component} style={toggled ? { backgroundColor: "#00000010" } : {}}>
            ...
            {toggled ?
                <div className={styles.list}>
                    ...
                    <SubButton text="Title" qKey="title" cmp="titleVal" setState={setTitle} setFilter={setReleasedFilter} type="string" mandatory={true} />
                    <SubButton text="Released" qKey="released" cmp="releasedVal" setState={setReleased} setFilter={setYearFilter} type="number" />
